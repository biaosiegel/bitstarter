...
var checkHtmlFile = function(htmlfile, checksfile) {
    ...
    var checkJson = checkHtmlContent(content, checksfile);
    outputJsonResult(checkJson);
 }

var checkHtmlLink = function(htmllink, checksfile) {
    rest.get(htmllink)
...
if (require.main == module) {
	...
	.option('-u, --url <url_link>', 'Url link to download html file to be graded') 
	.parse(process.argv);  
    ...
    {
	checkHtmlLink(program.url, program.checks);
    }

} else {
    exports.checkHtmlFile = checkHtmlFile;
    exports.checkHtmlLink = checkHtmlLink;
}
